...
def build(ctx):
    ...
    sources = [
        ...
        ( "audio/out/ao_coreaudio.m",            "coreaudio" ),
        ( "audio/out/ao_coreaudio_audiounit.m",  "coreaudio" ),
        #( "audio/out/ao_coreaudio_chmap.c",      "coreaudio" ),
        #( "audio/out/ao_coreaudio_exclusive.c",  "coreaudio" ),
        ( "audio/out/ao_coreaudio_audiotoolbox.c", "coreaudio" ),
        #( "audio/out/ao_coreaudio_properties.c", "coreaudio" ),
        ( "audio/out/ao_coreaudio_utils.m",      "coreaudio" ),
